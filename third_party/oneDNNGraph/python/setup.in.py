...
# and license files
ng_data_list = [
    @dnnl_graph_libraries@ @license_files@ @licence_top_level@
]
include_list.extend(ng_data_list)

# This is the contents of the Package Data
package_data_dict = {}
package_data_dict['tf_dnnl_graph_bridge'] = include_list

setup(
    name='dnnl_graph_tensorflow_bridge',
    version='0.22.0rc3',
    description='DNNL_GRAPH backend for TensorFlow',
    long_description=long_description,
    long_description_content_type="text/markdown",
    url='https://github.com/NervanaSystems/tf-dnnl_graph.git',
    packages=['tf_dnnl_graph_bridge'],
    author='Intel',
