...
execute_process(
    COMMAND
    ${TF_DNNL_GRAPH_PYTHON} -c "import tensorflow as tf; print(tf.sysconfig.get_include())"
...
if(${result})
  ...
  # make this Y/N TBD-swapna
  message(FATAL_ERROR "Installing tensorflow with pip.. ")
endif()
MESSAGE(STATUS "TensorFlow_INCLUDE_DIR: " ${TensorFlow_INCLUDE_DIR})

execute_process(
    COMMAND
    ${TF_DNNL_GRAPH_PYTHON} -c "import tensorflow as tf; print(tf.sysconfig.get_lib())"
    RESULT_VARIABLE result
...
execute_process(
    COMMAND
    ${TF_DNNL_GRAPH_PYTHON} -c "import tensorflow as tf; print(tf.__cxx11_abi_flag__)"
    RESULT_VARIABLE result
...
execute_process(
    COMMAND
    ${TF_DNNL_GRAPH_PYTHON} -c "import tensorflow as tf; print(tf.__git_version__)"
    RESULT_VARIABLE result
...
execute_process(
    COMMAND
    ${TF_DNNL_GRAPH_PYTHON} -c "import tensorflow as tf; print(tf.__version__)"
    RESULT_VARIABLE result
...
execute_process(
    COMMAND
    ${TF_DNNL_GRAPH_PYTHON} -c "import tensorflow as tf; print(tf.sysconfig.get_link_flags()[1][3:], end='')"
    RESULT_VARIABLE result
...
message(STATUS "TensorFlow_FRAMEWORK_LIBRARY: ${TensorFlow_FRAMEWORK_LIBRARY}" )
