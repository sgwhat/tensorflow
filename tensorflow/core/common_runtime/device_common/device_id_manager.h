...
#ifndef TENSORFLOW_CORE_COMMON_RUNTIME_DEVICE_COMMON_DEVICE_ID_MANAGER_H_
#define TENSORFLOW_CORE_COMMON_RUNTIME_DEVICE_COMMON_DEVICE_ID_MANAGER_H_
...
#endif  // TENSORFLOW_CORE_COMMON_RUNTIME_DEVICE_COMMON_DEVICE_ID_MANAGER_H_
