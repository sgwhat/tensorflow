...
==============================================================================*/
#ifndef TENSORFLOW_CORE_KERNELS_MKL_MKL_ELTWISE_OPS_H_
#define TENSORFLOW_CORE_KERNELS_MKL_MKL_ELTWISE_OPS_H_
...
class MklEltwiseFwdPrimitive : public MklPrimitive {
 ...
 private:
  // Primitive reuse context for eltwise Fwd ops: Relu, Elu, Tanh etc.
...
class MklEltwiseBwdPrimitive : public MklPrimitive {
 ...
 private:
  // Primitive reuse context for eltwise Bwd ops: Relu, Elu, Tanh etc.
...
class MklEltwiseOpBase : public OpKernel {
 public:
  ~MklEltwiseOpBase() {}

  explicit MklEltwiseOpBase(OpKernelConstruction* context, float alpha,
                            float beta)
...
template <typename Device, typename T, algorithm alg_kind>
class MklEltwiseGradOpBase : public OpKernel {
 public:
  ~MklEltwiseGradOpBase() {}

  explicit MklEltwiseGradOpBase(OpKernelConstruction* context, float alpha,
                                float beta)
      : OpKernel(context), alpha_(alpha), beta_(beta) {}
...
#endif  // INTEL_MKL
#endif  // TENSORFLOW_CORE_KERNELS_MKL_MKL_ELTWISE_OPS_H_
