...
def tf_workspace(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        strip_prefix = "sqlite-amalgamation-3290000",
        system_build_file = clean_dep("//third_party/systemlibs:sqlite.BUILD"),
        urls = [
            "http://mirror.tensorflow.org/www.sqlite.org/2019/sqlite-amalgamation-3290000.zip",
            "https://www.sqlite.org/2019/sqlite-amalgamation-3290000.zip",
        ],
    )
    ...
    tf_http_archive(
        ...
        urls = [
            "https://mirror.bazel.build/curl.haxx.se/download/curl-7.65.3.tar.gz",
    ...
    java_import_external(
        ...
        jar_urls = [
            "http://mirror.bazel.build/repo1.maven.org/maven2/org/checkerframework/checker-qual/2.10.0/checker-qual-2.10.0.jar",
