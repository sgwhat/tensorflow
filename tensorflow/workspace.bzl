...
def tf_workspace(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        urls = [
            "http://mirror.tensorflow.org/curl.haxx.se/download/curl-7.66.0.tar.gz",
    ...
    java_import_external(
        ...
        jar_urls = [
            "http://mirror.tensorflow.org/repo1.maven.org/maven2/org/checkerframework/checker-qual/2.10.0/checker-qual-2.10.0.jar",
