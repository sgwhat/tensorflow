...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        strip_prefix = "oneDNN-1.6.3",
        urls = [
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/oneapi-src/oneDNN/archive/v1.6.3.tar.gz",
            "https://github.com/oneapi-src/oneDNN/archive/v1.6.3.tar.gz",
        ],
    )
